                                            ...
                                            <div class="gal-home-content">
                                                <div class="row">
                                                    <div class="col-md-12"> 
                                                        ...
                                                        <p class="para-tours"><?php echo substr($tour_package['short_description'], 0, 120) . '...'; ?></p>
                                                        <span class="readmore-span">
                                                            <a href="view-tour-packages.php?id=<?php echo $tour_package["id"];?>" class="btn-content2">Read More</a>
                                                        </span>
